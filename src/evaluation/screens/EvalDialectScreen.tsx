...
export default function EvalDialectScreen() {
  const { state, setSelectedDialect, setPhase } = useEvaluation();
  ...
  return (
    <div className="min-h-screen bg-neutral-100 px-4 py-12">
      <div className="mx-auto max-w-lg">
        <p className="mb-2 text-sm text-neutral-500">Before comparisons</p>
