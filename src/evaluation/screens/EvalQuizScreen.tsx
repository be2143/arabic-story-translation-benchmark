...
import {
  ...
  shuffleEvaluationQuizQuestions,
  type EvaluationQuizQuestion,
} from "@/data/evaluationQuiz";
...
export default function EvalQuizScreen() {
  const { setPhase, setQuizResults } = useEvaluation();
  const questions = useMemo(
    () => shuffleEvaluationQuizQuestions(evaluationQuizQuestions),
    []
  );
