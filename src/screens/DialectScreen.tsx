  ...
  return (
    <div className="min-h-screen bg-neutral-100 px-4 py-12">
      <div className="mx-auto max-w-lg">
        <p className="mb-2 text-sm text-neutral-500">Before translation</p>
        ...
        <div className="mb-6 rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm leading-relaxed text-amber-950">
          ...
          <p className="mt-2">
            ...
            You must translate <strong>only</strong> into that dialect. Translating into a different
            dialect, or submitting incomplete work, may mean your submission does{" "}
            <strong>not</strong> qualify for compensation.
          </p>
        </div>

        <p className="mb-4 text-sm leading-relaxed text-neutral-700">
          Select the dialect you were assigned below. This choice should match your email
